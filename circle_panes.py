...
def pane_location(screen_resolution):
    pane_top_x = random.randint(0, screen_resolution.width)
    pane_top_y = random.randint(0, screen_resolution.height)
    pane_bottom_x = pane_top_x + random.randint(screen_resolution.width // 5)
    pane_bottom_y = pane_top_y + random.randint(screen_resolution.height // 5)
